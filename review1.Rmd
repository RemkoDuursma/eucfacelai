...
*TODO* **We have included more background on the design of the litter collection methods. As the table below shows, the number and size (and fractional area of the plot covered) are in the upper range of six other FACE experiments. It is clear from this comparison that our methods are justified. Further, the standard errors for litter within a plot BLAH BLAH**
...
**We have moved this analysis, including the methods, to the Supporting Information. We believe this is interesting information for others concerned with LAI estimation, but agree it is a side-objective. We only briefly mention in the Methods that the two methods gave comparable results.**

Finally, the manuscript requires extensive editing for structure and flow. The introduction does not sufficiently establish the expectation of litter responses. 
...
**We have responded to this issue above.**
